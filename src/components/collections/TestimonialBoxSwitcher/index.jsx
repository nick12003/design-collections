...
const TestimonialBoxSwitcher = () => {
  ...
  return (
    <div className={styles.TestimonialBoxSwitcher}>
      <div className={styles['testimonial-container']}>
        <div className={styles['progress-bar']}></div>
        <FaQuoteRight className={classNames(styles['fa-quote'], styles.right)} />
        <FaQuoteLeft className={classNames(styles['fa-quote'], styles.left)} />
        <p className={styles.testimonial}>{testimonials[index].text}</p>
        <div className={styles.user}>
          <img src={testimonials[index].photo} alt="user" className={styles['user-image']} />
